...
string  lcs(int i1, int i2,const  string & s1,const string &s2){
    ...
    if(s1[i1]== s2[i2]){
        return lcs(i1-1,i2-1,s1,s2)+s1[i1];
    }else
    {
        string leftString = lcs(i1,i2-1,s1,s2);
        string rightString = lcs(i1-1,i2,s1,s2);
        return leftString.size()>rightString.size()?leftString:rightString;
    }
